export class OnyriaPlayerHand extends CardsHand {

    static get defaultOptions() {
        return foundry.utils.mergeObject(super.defaultOptions, {
            classes: ["onyria", "sheet", "cardsHand", "cards-config"],
            width: 400,
            height:350,
            resizable: false,
        })
    ...
    get template() {
        let path;
        path = "systems/onyria/templates/cards/onyriaPlayerHand_evantail.hbs";
        return path;
