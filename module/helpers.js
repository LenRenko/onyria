...
export const registerHandlebarsHelpers = function () {
    ...
    Handlebars.registerHelper('getArraySubCategorywithItems', function (items) {
        let subCat=ONYRIA.itemSubCategories;
        var itemByCat = [];
        ...
        itemByCat.push({
            key: "",
            value: game.i18n.localize("ONYRIA.category.other"),
            items: weapons
        });
    ...
    Handlebars.registerHelper('isEnabled', function (configKey) {
        return game.settings.get("onyria", configKey);
    });

    Handlebars.registerHelper('isOnyriaTypeSetting', function (configKey) {
        return (game.settings.get("onyria", "onyriaVersion") == configKey);
    });
