...
export class GlobalOnyriaItemSheet extends ItemSheet {
    ...
    async _onEditItem(ev){
        ...
        let pack = null;
        switch(itemType){
            case "origine" : pack = "onyria.origines"; break;
            case "profession" : pack = "onyria.professions"; break;
            case "competence" : pack = "onyria.competences"; break;
        }
    ...
    _getItemProperties(item) {
        ...
        if ( item.type === "item" ) {
            ...
            props.push(...entries.filter(e => e[1] === true).map(e => {
                return game.onyria.config.itemProperties[e[0]]
            }));
        }
