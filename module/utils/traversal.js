export class Traversal {
    ...
    static getItemsOfType(type) {
        ...
        switch(type){
            case "competence" :
                compendium = game.onyria.config.competences;
    ...
    static getAllCompetencesData () {
        const compendium = game.onyria.config.competences;
        const compendiumSpe = game.onyria.config.competencesSpe;
    ...
    static getAllProfessionsData () {
        const compendium = game.onyria.config.professions;
    ...
    static getAllOriginesData () {
        const compendium = game.onyria.config.origines;
